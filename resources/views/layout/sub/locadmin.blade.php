...
<div style="margin-left:17%;padding:1px 16px;height:1000px;">
  ...
  <div class="box" style="width: 60%;">
    <div class="clearfix">
    <img class="box" src="lg1.jpg"  style="width:40px; height:40px;"> 
  ...
  <div class="clearfix" style="margin-top: 20px;">
    <div class="box" style="margin-left: 10px;width:90px;"><input name="tkiem" value="Tìm kiếm" type="submit"></div>

    <input type="password" name="mkad2" placeholder="Nhập username..." style="width:200px; height:25px;"> </div>
     <div class="clearfix" style="margin-top: 20px;">

    <div class="box"><a href="taikhoan"><input type="submit" name="us" value="Xem tất cả " style="margin-top: 20px;margin-bottom: 30px; margin-left:10px;"></a></div>
  
    <div class="box" ><a href="locngdung"><input type="submit" name="ad"  value="Lọc tài khoản người dùng " style="margin-top:20px;margin-bottom: 30px; margin-left: 20px;"></a></div>
  </div>
  {{csrf_field()}}
</form>
  </div>
