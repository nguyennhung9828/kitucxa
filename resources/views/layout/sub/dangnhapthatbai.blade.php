...
<body style="background-image: url('backend/img/ha2.jpg');">
  <div style="border: 2px solid #7f7f7f; margin: auto;width:400px;height: 250px;">
    <div class="clearfix">
  ...
  <form method="post" action="{{route('dn')}}">
    ...
    <div class="box" style="margin-left: 50px;font-size:18px;width: 100px;">Tài Khản :</div>
 ...
 <div class="clearfix" style="margin-top: 20px;">
  ...
  <p style="color:#ff0000; padding-left:50px; ">Tài Khoản không chính xác, Xin thử lại</p>
</div>
