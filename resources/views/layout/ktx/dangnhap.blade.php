...
<body style="background-image: url('backend/img/ha2.jpg');">
  ...
  <div class="clearfix" style="margin-top: 20px;">
    ...
    <div class="box"><p style="margin-top: 20px;margin-left: 20px;border: 1px solid #a5a49d;background-color: #ededed; padding-left: 5px;padding-right: 5px;" value="Thoát"> <a  href="dangkytk">Đăng Kí</a></div>
  </div>
</div>
