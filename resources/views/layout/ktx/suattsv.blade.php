...
<ul>
  ...
  <li><a href="QLtaikhoar">Quản Lý Tài Khoản</a></li>
...
<div style="margin-left:17%;padding:1px 16px;height:600px;">
  ...
  <form style="margin-top: 15px;" class="form-inline" action="{{route('tksua')}}" method="post">
              ...
              <table class="table table-bordered">
                        ...
                        <tbody>
                         ...
                         <form method="post" action="{{route('suaphong')}}">  
                          ...
                          <td>{{$sv->gioitinh}}</td>
                          <td>
                            <input type="text" name="ph" style="width:100px;" placeholder="{{$sv->phong}}">
                          </td>
                           
                          <td>
                            <a href=""><button class="btn btn-warning">Sửa</button> 
                          </a></td>
                                  </tr>
                                    {{csrf_field()}}
                                </form>
...
<a href="ttsv"><button class="btn btn-success"> << Trở về trang trước</button></a>
