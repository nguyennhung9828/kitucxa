...
<div style="margin-left:17%;padding:1px 16px;height:600px;">
  ...
  <img src="backend/img/lg3.png" width="40" height="30"><a href="#">Yêu cầu đăng kí của sinh viên</a>
  <a href="ttsv" style="padding-left: 7px;">|  Thông tin sinh viên</a>
  </div>
  ...
  <form style="margin-top: 15px;" class="form-inline" action="{{route('timsv')}}" method="post" >
  ...
  <h5 style="padding-top: 20px;">Yêu cầu đăng kí của sinh viên </h5>
...
<div>
  ...
  <a href="xulytt"> <button class="btn btn-success" type="submit" style="margin-left:930px;">Xử lý thông tin >></button></a>
